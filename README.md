...
| 플랫폼 | PC |
| 개발 인원 | 5명 |
| 담당 (서재민) | 보스 AI 시스템, 일반 몹 시스템, 전투 이펙트, 보스 BGM |
...
| 이름 | 담당 |
|------|------|
| 서재민 | 보스 AI 전체, 일반 몹 시스템, 전투 이펙트, 보스 BGM |
| 현 (File_Hyun) | 플레이어 시스템, 무기(활/창/폭탄), State Machine |
| 서일 (File_Seoil) | 스테이지 매니저, 튜토리얼, 씬 구성 |
| 수진 (cranberryandmixnuts) | UI, 무기 설명, 다이얼로그 |
